...
import ru.yandex.practicum.kafka.telemetry.analyzer.service.snapshot.handler.SensorSnapshotEventHandler;
...
public class SnapshotProcessor {
    ...
    public void start() {
        ...
        try {
            snapshotClient.getConsumer().subscribe(List.of(snapshotClient.getTopics().get(TopicType.SENSORS_SNAPSHOTS)));
            while (true) {
                try {
