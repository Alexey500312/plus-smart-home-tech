package ru.yandex.practicum.kafka.telemetry.analyzer.service.hub;
...
import ru.yandex.practicum.kafka.telemetry.analyzer.service.client.Client;
import ru.yandex.practicum.kafka.telemetry.analyzer.service.hub.handler.HubEventHandler;
import ru.yandex.practicum.kafka.telemetry.analyzer.service.hub.handler.HubEventType;
...
import static ru.yandex.practicum.kafka.telemetry.analyzer.service.OffsetManager.manageOffsets;
...
public class HubEventProcessor implements Runnable {
    ...
    public void run() {
        ...
        try {
            hubClient.getConsumer().subscribe(List.of(hubClient.getTopics().get(TopicType.HUBS_EVENTS)));
            while (true) {
                try {
